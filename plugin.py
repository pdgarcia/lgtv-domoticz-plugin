#
#       LG TV Plugin Author: , 2017
#
"""
<plugin key="lgtv" name="LG TV" author="Pablo Garcia" version="0.1" wikilink="" externallink="http://www.lg.com/us/tvs">
    <description>
...
* Determine the MAC address of your TV: [Settings] => [Network] => [Network Setup] => [View Network Status]<br/>
    ...
    <params>
        ...
        <param field="Mode7" label="Confirmation Code" width="200px" required="true" default="XXXX"/>
    </params>
</plugin>
"""
import Domoticz
